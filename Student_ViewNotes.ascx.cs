...
public partial class Student_ViewNotes : System.Web.UI.UserControl
{
    ...
    protected void DataList1_ItemCommand(object source, DataListCommandEventArgs e)
    {
        if (e.CommandName == "Download")
        {
            ...
            cmd4.CommandText = "select * from tblNotes where NoteID=@nid";
            cmd4.Parameters.AddWithValue("@nid", noteid);
